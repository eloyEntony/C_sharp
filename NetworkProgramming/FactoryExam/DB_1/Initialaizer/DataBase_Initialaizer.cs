...
namespace DB_1.Initialaizer
{
    class DataBase_Initialaizer: DropCreateDatabaseIfModelChanges<AppContext>
    {
        protected override void Seed(AppContext context)
        {
            ...
            var workers = new List<Employee>
            {
                ...
                new Employee{ Name = "Robert", Surname ="Indiana",
                                ...
                                //DepartmentId = 2, // context.Departaments.FirstOrDefault(x=>x.Id == 2).Id,
                                Email = "fdbcy@fds.sda",
                 ...
                 new Employee{ Name = "Jack", Surname ="Walski",
                                ...
                                //DepartmentId = 3,//context.Departaments.FirstOrDefault(x=>x.Id == 3).Id,
                                Email = "bvbc@fds.sda",
                    ...
                    new Employee{ Name = "Mack", Surname ="Luis",
                                    ...
                                    //DepartmentId = 4,//context.Departaments.FirstOrDefault(x=>x.Id == 4).Id,
            ...
            emp1.DepartmentId = context.Departaments.FirstOrDefault(x => x.Id == 1).Id;
            emp2.DepartmentId = context.Departaments.FirstOrDefault(x => x.Id == 2).Id;
            emp3.DepartmentId = context.Departaments.FirstOrDefault(x => x.Id == 3).Id;
            emp4.DepartmentId = context.Departaments.FirstOrDefault(x => x.Id == 4).Id;
            context.SaveChanges();
